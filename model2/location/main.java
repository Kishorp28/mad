                ...
                public void onSuccess(Location location) {
                    if (location != null) {
                        ...
                        try {
                            ...
                            lattitude.setText("Lattitude :" +addressess.get(0).getLatitude());
                            longitude.setText("Longitude :" + addressess.get(0).getLongitude());
                            address.setText("Address :" + addressess.get(0).getAddressLine(0));
                            city.setText("City: " + addressess.get(0).getLocality());
                            country.setText("Country : " + addressess.get(0).getCountryName());
                            Log.d("Location", "Addressess :" + addressess.toString());
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
